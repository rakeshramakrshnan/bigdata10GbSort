...
/**
 * The following set of codes will convert the data from sorted file into 
 * Tera Input Input Format to read the first 10 characters of each line as 
 * the key and the rest of the line as the value. Both key and value are 
 *  represented as Text.
 */
