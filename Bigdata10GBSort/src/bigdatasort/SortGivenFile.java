...
public class SortGivenFile extends MapValues{
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.print("Data generation started\n");
   		...
   		FileWriter writer = new FileWriter("D:/eclipse-workspace/Bigdata10GBSort/input/file1.csv", true) ;
   		DataGeneration.createfile(writer,"D:/eclipse-workspace/Bigdata10GBSort/input/file1.csv");
   				   	
   		System.out.print("Data generation completed and Copying files to hadoop");
		...
		System.out.println( sortJob.getJobName() );
		...
		System.out.println("Preinitialize job State");
